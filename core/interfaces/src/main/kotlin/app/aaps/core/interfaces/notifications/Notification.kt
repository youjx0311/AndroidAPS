...
open class Notification(
    ...
    open var level: Int = NotificationConstants.URGENT,
    open var validTo: Long = System.currentTimeMillis() + TimeUnit.MINUTES.toMillis(10),
    @RawRes open var soundId: Int? = null,
    open var action: Runnable? = null,
    open var buttonText: Int = 0,
    open var contextForAction: Context? = null
) {
